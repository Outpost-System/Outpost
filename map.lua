...
function map.dijkstra(graphmap, current, destination, directed)
    if not directed then 
        map.complete(graphmap) 
    end
    ...
    return distance_to[destination], map.follow(trail, destination)
end

function map.complete(graphmap)
...
function map.follow(trail, destination)
